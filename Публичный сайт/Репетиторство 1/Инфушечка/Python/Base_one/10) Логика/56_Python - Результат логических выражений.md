- [Правила преобразования](https://code-basics.com/ru/languages/python/lessons/logical-expressions#part-4aac52de0ef63d0b)
- [Составные выражения](https://code-basics.com/ru/languages/python/lessons/logical-expressions#part-a7549c5b61f2abc8)
- [Двойное отрицание](https://code-basics.com/ru/languages/python/lessons/logical-expressions#part-82548de62310a4d)
- [Ошибка выбора](https://code-basics.com/ru/languages/python/lessons/logical-expressions#part-920fd59740adb2fd)
...
Поэкспериментируйте с кодом в интерактивном репле [https://replit.com/@hexlet/python-basics-logical-expressions](https://replit.com/@hexlet/python-basics-logical-expressions)

Решение:

```python
def string_or_not(something):
    return (isinstance(something, str)) and 'yes' or 'no'
```
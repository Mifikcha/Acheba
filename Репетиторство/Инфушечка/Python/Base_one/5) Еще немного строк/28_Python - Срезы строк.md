...
Представим, что у нас есть дата в таком формате: _12-08-2034_. Нам нужно извлечь из нее подстроку, в которую входит только год.
...
[https://replit.com/@hexlet/python-basics-advanced-strings-slices](https://replit.com/@hexlet/python-basics-advanced-strings-slices)

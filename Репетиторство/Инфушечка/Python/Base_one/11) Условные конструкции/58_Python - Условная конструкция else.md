...
[https://replit.com/@hexlet/python-basics-conditionals-if-else](https://replit.com/@hexlet/python-basics-conditionals-if-else)
...
        if url[:8] == 'https://':
            result = url
        else: result = f'https://{url}'
    else: result = f'https://{url[7:]}'
    return result
```
...
[https://replit.com/@hexlet/python-basics-define-function](https://replit.com/@hexlet/python-basics-define-function)
...
Реализуйте функцию с именем `print_motto()`, которая выведет на экран фразу _Winter is coming_.

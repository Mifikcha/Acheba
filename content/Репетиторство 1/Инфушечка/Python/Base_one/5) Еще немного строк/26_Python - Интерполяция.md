...
[https://replit.com/@hexlet/python-basics-advanced-strings-interpolation](https://replit.com/@hexlet/python-basics-advanced-strings-interpolation)
...
full = f'Do you want to eat, {stark}?'
print(full)
# END
```
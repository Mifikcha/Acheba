...
<section class="home-graph-band" aria-labelledby="home-graph-title">
  <div class="home-section-head">
    <p>Карта материалов</p>
    <h2 id="home-graph-title">Граф связей</h2>
  </div>
...
<section class="home-resources" aria-labelledby="home-resources-title">
  <div class="home-section-head">
    <p>Что посмотреть</p>
    <h2 id="home-resources-title">Ключевые ресурсы</h2>
  </div>
</section>
...
<section class="home-proof" aria-labelledby="home-proof-title">
  <div class="home-section-head">
    <p>Отзывы</p>
    <h2 id="home-proof-title">Что говорят ученики</h2>
  </div>
  <div class="home-testimonials">
    <blockquote>Пока здесь будет место для отзывов.</blockquote>
    <blockquote>Еще один спокойный слот под будущую цитату.</blockquote>
  </div>
</section>
